    ...
    <div className="flex gap-6 md:gap-10">
      <div className="flex items-center">
        <Link href={`/${lang}`} className="items-center hidden space-x-2 md:flex">
          <div className="text-3xl">W3W.DELIVERY</div>
        </Link>

        <Link href="https://docs.saasfly.io" target="_blank" className="hidden ml-4 md:flex lg:flex xl:flex">
          <DocumentGuide>
            {typeof marketing?.introducing === "string" ? marketing?.introducing : "Introducing W3W.DELIVERY"}
          </DocumentGuide>
        </Link>
      </div>
